...
export default async function AdminSettingsPage({
  ...
  const [settings, totalProfiles] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      ...
      <AdminSurface>
        <p className="text-sm font-semibold text-orange-200">Default affiliate</p>
        <h2 className="mt-2 text-2xl font-bold text-white">
          Ubah presentase komisi
        </h2>
        <form action={updateAffiliateProgramSettings} className="mt-5 space-y-5">
          ...
          <div className="max-w-sm">
            ...
            <p className="mt-2 text-xs leading-5 text-neutral-500">
              Nilai ini akan dipakai sebagai rate komisi default untuk affiliate.
            </p>
          </div>
          ...
          <label className="flex items-start gap-3 rounded-[18px] border border-white/10 bg-black/20 p-4">
            ...
            <span>
              ...
              <span className="mt-1 block text-sm leading-6 text-neutral-400">
                Cocok dipakai saat kamu ingin mengubah rate global seluruh user
                affiliate tanpa edit satu per satu.
              </span>
            </span>
          </label>
